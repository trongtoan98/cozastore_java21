...
public class CustomAuthenProvider implements AuthenticationProvider {
    ...
    @Autowired
    @Lazy
//    Lazy dùng để đảm bảo PasswordEncoder phải chạy rồi, tránh việc tìm khồn thấy
...
// ddiefu kiện để đăng nhâp nhập thành công user phải tồn tại, password giống trong database
